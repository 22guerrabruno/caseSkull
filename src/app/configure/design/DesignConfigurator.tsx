...
const DesignConfigurator = ({
  ...
  return (
    <div className=' relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20'>
      ...
      justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:object-none
       focus:ring-2 focus:ring-rainbow focus:ring-offset-2 '>
      ...
      <div className='h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white'>
        <ScrollArea className=' relative flex-1 overflow-auto'>
          ...
          <div className='px-8 pb-12 pt-8'>
            <h2 className=' tracking-tight font-bold text-3xl text-center'>
              Costumize your case
            </h2>
