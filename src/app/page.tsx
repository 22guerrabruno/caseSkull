          ...
          <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
            <div className='relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start'>
              ...
              font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl'>
                Your Image on a{' '}
                <span className='bg-rainbow rounded-lg text-white px-2'>
                  Custom
                </span>
                Phone case
              </h1>
              <p className='mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap'>
                ...
                CaseSkull allaws you to protect your memories not just your
                phone case.
              </p>
              <ul className='mt-8 spy2 text-left font-medium flex flex-col items-center sm:items-start'>
                <div className=' space-y-2'>
                  <li className='flex gap-1.5 items-center text-left'>
                    <Check className=' shrink-0 w-5 h-5 text-red-600' />
                    High-quality, durable matirial
                  </li>
                  <li className='flex gap-1.5 items-center text-left'>
                    <Check className=' shrink-0 w-5 h-5 text-violet-600' />5
                    Year print warranty
                  </li>
                  <li className='flex gap-1.5 items-center text-left'>
          ...
          <div className='mb-12 px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl sm:text-center'>
              <h2 className='order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900'>
                ...
                <span className='relative px-2 bg-rainbow rounded-md text-white'>
                  your own case
                </span>{' '}
                now
              </h2>
